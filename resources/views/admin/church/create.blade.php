...
@section('title', 'Igreja Controle - Cadastrar igreja')

@section('content_header')
    <h1><i class="fa fa-home" aria-hidden="true"></i> Cadastrar igreja</h1>
...
<form role="form" method="POST" action="{{ route('church.store') }}" enctype="multipart/form-data">
@csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary" style="padding: 10px">
                    ...
                    <img title="Editar imagem" onclick="openModalPhoto()" style="display: block; margin-right: auto; margin-left: auto; cursor: pointer;" src="{{ url('storage/churches/default.jpg') }}" class='img img-circle' width='149'>
                </div>
            </div>
        </div>
                                    ...
                                    <div class='col-md-6'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id='name' name='name' type="text" class="form-control" required value="{{ old('name') }}" autofocus>
                                            </div>
                                        </div>
                                    ...
                                    <div class='col-md-6'>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id='cnpj' name='cnpj' type="text" class="form-control" value="{{ old('cnpj') }}" required>
                                            </div>
                                        </div>
                    ...
                    <div class='col-md-3'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type='text' name="complement" id="complement" value="{{ old('complement') }}" class="form-control">
                            </div>
                        </div>
